...
object MailServiceUtils {
    const val START_CONTENT = "<div class=\"\"><div class=\"aHl\"></div><div id=\":ob\" tabindex=\"-1\"></div><div id=\":n4\" class=\"ii gt\" jslog=\"20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.\"><div id=\":n5\" class=\"a3s aiL msg40231263648748703\"><u></u>\n" +
        ...
        "<div id=\"m_40231263648748703body_sec2_textsec\"><p style=\"font-family:Helvetica;color:#232f3e;font-size:14px\">hannah-education 회원 가입 인증번호 메일입니다.</p><p>본 메일은 회원 가입을 위해 발송되는 메일입니다. 본인이 요청한 회원 가입이 아니라면 개인정보 보호를 위해 계정 설정을 변경해주세요.</p><p>hannah-education에 회원 가입하시려면 본인 인증을 위해 아래 8자리 코드를 입력해주세요.</p>\n" +
